...
<head>
  ...
  <link href="{{asset('clients/assets/vendor/owl.carousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
...
<body>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="fixed-top d-flex align-items-center shadow-lg">
    <div class="container d-flex align-items-center justify-content-between">

      <h1 class="logo"><a href="index.html">ASTG</a></h1>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>Groovin</h3>
              <p>
                Tesano Police station, <br>
                Accra Ghana<br><br>
                <strong>Phone:</strong> +233504576123<br>
                <strong>Email:</strong> aestg@gmail.com<br>
              </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>AESTG</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
  ...
  <!-- Vendor JS Files -->
  <script src="{{asset('clients/assets/vendor/jquery/jquery.min.js')}}"></script>
  <script src="{{asset('clients/assets/vendor/purecounter/purecounter.js')}}"></script>
  <script src="{{asset('clients/assets/vendor/owl.carousel/owl.carousel.min.js')}}"></script>
  <script src="{{asset('clients/assets/js/jquery.counterup.min.js')}}"></script>
